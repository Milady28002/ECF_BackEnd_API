...
public function register(Request $request, MailerInterface $mailer): JsonResponse
{
                ...
                <body style="font-family: Arial, sans-serif; background:#f5f5f5; padding:20px;">
                    <div style="max-width:600px; margin:0 auto; background:#ffffff; padding:30px; border-radius:12px; box-shadow:0 6px 18px rgba(0,0,0,0.08);">
                        ...
                        <p style="margin:24px 0;">
                            <a href="https://vite-et-gourmand-traiteur.vercel.app/#/signin" style="background:#7bbd2f; color:#fff; text-decoration:none; padding:12px 20px; border-radius:8px; display:inline-block;">
                                Se connecter
                            </a>
                        </p>
    ...
    public function forgotPassword(
       ...
       $token = bin2hex(random_bytes(32));
        ...
        $resetLink = 'https://vite-et-gourmand-traiteur.vercel.app/#/reset-password?token=' . $token;
